...
//
// Layout: keep the stock Android GPT (no repartition); stage-2 lives in the
// eMMC boot1 HW partition; OS artifacts go into existing stock partitions.
...
export const TC8_FILTERS: UsbFilter[] = [
  { vendorId: 0x1fc9, productId: 0x0152 }, // the stage-2 fastboot gadget
...
/** Subset of the stock Android GPT provisioned into. Identity parts preserved. */
